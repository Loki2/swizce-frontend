                  ...
                  <li>
                    <a href="">
                      <div className="users__items">
                        <img src="https://assets.vogue.com/photos/60eef8c728198051b1f04558/1:1/w_1475,h_1475,c_limit/tgd3260_101_comp_v007_35250b79%20(2).jpeg" alt="" />
                        <h4>@John_backey</h4>
                        <p>Active</p>
                      </div>
                    </a>
        ...
        <section className="home__main">
          {/* main container */}
            <div className="home__container">
              {
                data && data.screams.map((scream) => <Home scream={scream} key={scream.id} />)
              }
            </div>
        </section>
